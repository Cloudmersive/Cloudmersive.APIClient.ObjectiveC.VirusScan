...
///
///  @returns CMVirusScanAdvancedResult*
///
-(NSURLSessionTask*) scanFileAdvancedWithInputFile: (NSURL*) inputFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/virus/scan/file/advanced"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMVirusScanAdvancedResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMVirusScanAdvancedResult*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) scanWebsiteWithInput: (CMWebsiteScanRequest*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/virus/scan/website"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMWebsiteScanResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMWebsiteScanResult*)data, error);
                                }
                            }];
}
